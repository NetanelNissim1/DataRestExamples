...
@Entity
@Table(name = "cntry_names_usa", indexes = {
		@Index(name = "cntryNamesUsaPrimary", columnList = "cli,name", unique = true) })
public class Cntry_Names_Usa implements Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = -5977606511176085253L;
	@Id
	...
	public String toString() {
		return "Cntry_Names_Usa [cli=" + cli + ", name=" + name + ", type=" + type + "]";
	}

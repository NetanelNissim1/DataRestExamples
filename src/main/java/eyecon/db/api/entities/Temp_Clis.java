...
@Entity(name = "temp_clis")
public class Temp_Clis implements Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = -8476128954268354121L;
	@Id

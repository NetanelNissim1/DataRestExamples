...
@Entity
@Table(name = "users", indexes = { @Index(name = "users_client_id_IX", columnList = "client_id", unique = true),
		@Index(name = "users_cli_IX", columnList = "cli", unique = true) })
public class Users implements Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = -6543279380944100775L;
	...
	public String toString() {
		return "Users [clientId=" + clientId + ", gRegId=" + gRegId + ", aRegId=" + aRegId + ", cli=" + cli

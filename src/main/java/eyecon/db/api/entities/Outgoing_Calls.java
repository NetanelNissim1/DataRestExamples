...
@Entity
@Table(name = "outgoing_calls", indexes = {
		@Index(name = "outgoingCallsIsFinal_cli", columnList = "is_final_status,cli"),
		@Index(name = "outgoingCallsPrimary", columnList = "provider_id,call_id", unique = true) })
public class Outgoing_Calls implements Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = -5123612510986841891L;
	@Id
	@Column(name = "provider_id", nullable = false, precision = 10)
	private int providerId;
	@Id
	@Column(name = "call_id", nullable = false, length = 40)
	...
	/**
	 * Access method for callId.
	 *
	 * @return the current value of callId
	 */
	...
	/**
	 * Setter method for callId.
	 *
	 * @param aCallId the new value for callId
	 */
	public void setCallId(String aCallId) {
		callId = aCallId;
	}
	...
	public String toString() {
		return "Outgoing_Calls [providerId=" + providerId + ", callId=" + callId + ", cli=" + cli + ", cliCc=" + cliCc
